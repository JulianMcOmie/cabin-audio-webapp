...
// Pattern timing
const BURST_INTERVAL = 0.25; // seconds between bursts
const ROW_PAUSE = 0.25; // pause between rows

// Filter settings
const DEFAULT_Q = 5.0; // Q for bandwidth
...
const FIXED_BANDWIDTH = 0.00; // Fixed bandwidth for noise bursts in octaves
