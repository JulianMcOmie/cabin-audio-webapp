        ...
        >
          <div className="flex items-center min-w-0">
            <div className="min-w-0">
              ...
              <p className="text-[11px] dark:text-white/40 text-black/40 truncate">{instruction}</p>
            </div>
          </div>
          <div className="flex items-center gap-3 shrink-0 ml-3">
            ...
            <button
              ...
              className={`text-[11px] font-medium px-2.5 py-1 rounded-full border transition-colors ${
                isEQEnabled
                  ? `${pc.bgSubtle} ${pc.text} ${pc.border}`
                  : "dark:bg-white/5 bg-black/5 dark:text-white/40 text-black/40 dark:border-white/8 border-black/8"
              }`}
            >
              {isEQEnabled ? "Active" : "Inactive"}
            </button>
            <button
              onClick={onClose}
